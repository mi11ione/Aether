...
//  AetherTests
//
//  Comprehensive test suite for QuantumState struct.
//  Validates state vector representation, normalization, probability calculations,
//  and qubit indexing for scalable quantum simulation (1-24+ qubits).
//
...
struct StateErrorHandlingTests {
    ...
    func normalizeZeroStateThrows() {
        ...
        #expect(throws: QuantumStateError.self) {
            try state.normalize()
        }
    }
