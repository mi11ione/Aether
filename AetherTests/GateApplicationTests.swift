//
//  GateApplicationTests.swift
//  AetherTests
//
//  Comprehensive test suite for GateApplication engine.
//  Validates quantum gate application algorithms, state transformations,
//  normalization preservation, and scalability across qubit counts.
//
...
struct CNOTGateTests {
    ...
    func cnotOnZeroOne() {
        let amplitudes = [
            Complex<Double>.zero, // |00⟩ - index 0
            Complex<Double>.one, // |01⟩ - index 1 (qubit 0 = 1)
            Complex<Double>.zero, // |10⟩ - index 2 (qubit 1 = 1)
            Complex<Double>.zero, // |11⟩ - index 3
        ]
